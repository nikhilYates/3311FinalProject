...
public class NewsletterTest {
	...
	public void testAddSubscription() {
		...
		assertFalse("Subscription list should not be empty after adding a subscription",
				newsletter.listSubscriptions().isEmpty());
		assertTrue("Subscription list should contain the added subscription",
				newsletter.listSubscriptions().contains(subscription));
	}
	...
	public void testCancelSubscriptionNotExists() {
		assertFalse("Canceling a non-existing subscription should return false",
				newsletter.cancelSubscription("sub003"));
	}
	...
	public void testChooseNewsletter() {
		...
		assertEquals("chooseNewsletter should return a newsletter with the specified ID", newsletterID,
				chosenNewsletter.getNewsletterID());
	}
