...
public class StudentTest {
    ...
    public void testAddToRentalList() {
        ...
        RentalTransaction rental = new RentalTransaction(1, 1, "003", LocalDate.now(), LocalDate.now().plusDays(30), 0.0, false);
    ...
    public void testRentalListSizeAfterMultipleAdditions() {
        student.addToRentalList(new RentalTransaction(1, 1, "003", LocalDate.now(), LocalDate.now().plusDays(30), 0.0, false));
        student.addToRentalList(new RentalTransaction(2, 1, "004", LocalDate.now(), LocalDate.now().plusDays(15), 0.0, false));
    ...
    public void testRentalListNotEmptyAfterAdding() {
        RentalTransaction rental = new RentalTransaction(2, 1, "004", LocalDate.now(), LocalDate.now().plusDays(20), 0.0, false);
        student.addToRentalList(rental);
