...
public class OnlineBookTest {
    ...
    public void testOpenBookNotAvailable() {
        onlineBook.setAvailableForReading(false);
        // Similarly, this assumes console output. Actual testing might require different approach.
        onlineBook.openBook();
    }

    @Test
    public void testCloseBook() {
        // Assuming the method prints to the console. Actual testing might need to capture stdout or use a different approach.
    ...
    public void testTopicsImmutable() {
        ...
        assertNotEquals("Modifying the array obtained from getTopics should not affect the original topics", originalTopics[0], modifiedTopics[0]);
    }
