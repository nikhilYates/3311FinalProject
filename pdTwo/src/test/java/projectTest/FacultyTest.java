...
public class FacultyTest {
	...
	public void testAddToRentalList() {
		...
		RentalTransaction rental = new RentalTransaction(1, 1, "001", LocalDate.now(), LocalDate.now().plusDays(30),
				0.0, false);
	...
	public void testRentalListSizeAfterMultipleAdditions() {
		...
		faculty.addToRentalList(
				new RentalTransaction(2, 1, "002", LocalDate.now(), LocalDate.now().plusDays(15), 0.0, false));
	...
	public void testRentalListNotEmptyAfterAdding() {
		RentalTransaction rental = new RentalTransaction(2, 1, "003", LocalDate.now(), LocalDate.now().plusDays(20),
				0.0, false);
		faculty.addToRentalList(rental);
	...
	public void testRentalListContainsSpecificRental() {
		RentalTransaction rental = new RentalTransaction(3, 1, "004", LocalDate.now(), LocalDate.now().plusDays(10),
				0.0, false);
		faculty.addToRentalList(rental);
	...
	public void testRentalListDoesNotContainRemovedRental() {
		RentalTransaction rental = new RentalTransaction(4, 1, "005", LocalDate.now(), LocalDate.now().plusDays(25),
				0.0, false);
		faculty.addToRentalList(rental);
		faculty.removeFromRentalList(rental);
