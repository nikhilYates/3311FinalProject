...
public class ItemTest {
    ...
    public void testSetDiscountPrice() {
        ...
        assertEquals("Discount price should be updated by setDiscountPrice", newDiscountPrice, item.getDiscountPrice(), 0.01);
    }
    ...
    public void testDiscountPriceLessThanPrice() {
        assertTrue("Discount price should be less than or equal to the price", item.getDiscountPrice() <= item.getPrice());
    }
