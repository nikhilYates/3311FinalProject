...
public class TextbookAccessTest {
    ...
    public void setUp() {
        ...
        courses = new ArrayList<>(Arrays.asList(new Course("CS101", "Intro to CS"), new Course("CS102", "Data Structures")));
        textbooks = new ArrayList<>(Arrays.asList(new Textbook("TB101", "Intro to CS Textbook"), new Textbook("TB102", "Data Structures Textbook")));
    ...
    public void testAccessTextbook() {
        // This test checks the console output, you might need a different approach to test this functionality
    ...
    public void testRemoveAccess() {
        ...
        assertFalse("Textbook should be removed from the list", textbookAccess.getTextbooks().contains(textbooks.get(0)));
    }
    ...
    public void testAccessNonexistentTextbook() {
        // Assuming there's a way to check if the textbook was not accessed, e.g., through a flag or method
    }
    ...
    public void testRemoveNonexistentTextbook() {
        ...
        // Assuming there's a way to verify that the removal did not affect the textbooks list
    }
