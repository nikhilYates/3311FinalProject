...
public class CourseManagementTest {
    ...
    public void testNotifyNewEditions() {
        ...
        // This test should check the output to the console, but since capturing console output in JUnit is non-trivial,
        // we're acknowledging the call here. In a real test, consider using a Logger and verifying the log output.
    }
    ...
    public void testNotifyUnavailability() {
        ...
        // Similar to testNotifyNewEditions, this test should ideally verify console output or log messages.
    }

    @Test
    public void testTrackCourses() {
        courseManagement.trackCourses(facultyID);
        // Assuming trackCourses should modify coursesTaught based on the facultyID. Since the method's implementation is not given,
