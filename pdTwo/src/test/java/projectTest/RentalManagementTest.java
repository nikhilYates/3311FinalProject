...
public class RentalManagementTest {
    ...
    public void testSelectRentedItemFound() {
        // Ensure the rental item is added to the internal list through the appropriate method
        rentalManagement.addRental(rental1);
    ...
    public void testSelectRentedItemNotFound() {
        assertNull("Selecting a non-existent item should return null", rentalManagement.selectRentedItem("nonExistentID"));
    }
    ...
    public void testDisplayDueDates() {
        ...
        // This test assumes the method prints to the console. In a real test, you'd capture stdout or refactor to be more testable.
    ...
    public void testDisplayRentalDetails() {
        rentalManagement.listRentedItems().add(rental1);
        // Similarly, this assumes console output. Actual testing might need a different approach.
    ...
    public void testRentalItemRemoval() {
        ...
        assertTrue("Rented items list should be empty after removing the item", rentalManagement.listRentedItems().isEmpty());
    }

    @Test
    public void testDueDateExtension() {
        rentalManagement.listRentedItems().add(rental1);
        Date newDueDate = new Date(rental1.getDueDate().getTime() + 3 * 24 * 60 * 60 * 1000); // Extend due date by 3 days
    ...
    public void testEmptyRentalListAfterUserIDChange() {
        ...
        assertTrue("Rented items list should be empty after changing the userID", rentalManagement.listRentedItems().isEmpty());
    }
    ...
    public void testRentalListImmutableFromOutside() {
        ...
        assertTrue("Changes to external list should not affect internal rented items list", rentalManagement.listRentedItems().isEmpty());
    }
}
