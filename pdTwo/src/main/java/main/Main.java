...
public class Main {
	...
	public static void main(String[] args) {
		...
		RentalTransaction transaction1 = new RentalTransaction("user01", "001", LocalDate.of(2024, 3, 1),
				LocalDate.of(2024, 3, 15), 1.50, false);
		RentalTransaction transaction2 = new RentalTransaction("user01", "003", LocalDate.of(2024, 3, 5),
				LocalDate.of(2024, 3, 19), 2.00, false);
		RentalTransaction transaction3 = new RentalTransaction("user01", "005", LocalDate.of(2024, 3, 10),
