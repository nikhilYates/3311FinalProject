...
public class MainUI extends JFrame {
	...
	private MainUI() {
		...
		// Set top bar
		JLabel chooseUserType = new JLabel("Register As: ");
		Vector<String> countriesNames = new Vector<String>();
		countriesNames.add("Student");
		countriesNames.add("Faculty");
		countriesNames.add("Teacher");
		countriesNames.add("Visitor");
