...
public class SystemManager {
	...
	private SystemManager() {}		// private constructor for singleton
	...
	public boolean deleteItem(PhysicalItem item) throws IOException {
        ...
        for (int i = sheet.getLastRowNum(); i >= 0; i--) {
        	...
        	if (row != null) {
        		...
        		if (cell != null && cell.getCellType() == CellType.NUMERIC && cell.getNumericCellValue() == Integer.parseInt(item.getItemID())) {
        			sheet.removeRow(row);
            	} else if (cell != null && cell.getCellType() == CellType.STRING && cell.getStringCellValue().equalsIgnoreCase(item.getItemID())) {
